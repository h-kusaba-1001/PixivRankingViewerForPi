<template>
  <v-app>
    <v-main>
      ...
      <router-view v-on:pics="getPics" v-on:slideItemNo="getSlideNo"></router-view>
    </v-main>
  </v-app>
</template>

<script>
	import SelectRankingGenre from "@/components/modal/SelectRankingGenre";
  ...
  export default {
    ...
    methods: {
      getPics(vals) {
        // 子コンポーネントからpicsを受け取って格納
        this.pics = vals
      },
      getSlideNo(slideNo) {
        this.slideItemNo = slideNo
      }
    }
  };
</script>
